    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.FileField(blank=True, help_text='Direct award document/certificate (legacy or single)', null=True, upload_to='awards/certificates/')),
                ('team_id', models.CharField(blank=True, help_text='Import-time grouping ID', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_datetime', models.DateTimeField(blank=True, help_text='Event start date and time', null=True)),
                ('end_datetime', models.DateTimeField(blank=True, help_text='Event end date and time', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Exam_Section', models.CharField(blank=True, default='ALL', help_text='Section: A, B, C, D, or ALL', max_length=10)),
                ('school_id', models.CharField(blank=True, db_index=True, editable=False, help_text='School ID for filtering (read-only, fetched from schools table)', max_length=100, null=True)),
                ('school_name', models.CharField(blank=True, editable=False, help_text='School name (read-only, auto-populated from schools table)', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.CharField(help_text='Section of the student (A, B, C, D)', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_id', models.CharField(blank=True, db_index=True, editable=False, help_text='School ID for filtering', max_length=100, null=True)),
                ('school_name', models.CharField(blank=True, editable=False, help_text='School name', max_length=255, null=True)),
                ('photo_id', models.CharField(blank=True, help_text='Gallery Photo ID (e.g., PID-123)', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.CharField(blank=True, choices=[('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D')], help_text='Section of the student (A, B, C, or D)', max_length=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_teacher_section', models.CharField(blank=True, help_text='Section for class teacher assignment (e.g., A, B, C, D)', max_length=10, null=True)),
                ...
                ('emergency_contact_relation', models.CharField(blank=True, help_text='Relation with emergency contact', max_length=50, null=True)),
                ('salary', models.CharField(blank=True, help_text='Salary information', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.CharField(blank=True, help_text='Section of the student', max_length=50, null=True)),
                ('address', models.TextField(default='Address not provided')),
                ('category', models.CharField(choices=[('General', 'General'), ('OBC', 'OBC'), ('SC', 'SC'), ('ST', 'ST'), ('EWS', 'EWS'), ('Other', 'Other')], default='General', max_length=20)),
                ('admission_number', models.CharField(blank=True, help_text='Generated after approval', max_length=50, null=True, unique=True)),
                ('parent_phone', models.CharField(blank=True, max_length=20, null=True)),
                ...
                ('remarks', models.TextField(blank=True, null=True)),
                ('profile_photo', models.CharField(blank=True, help_text='Profile photo URL or file path', max_length=100, null=True)),
                ('activities', models.TextField(blank=True, help_text='Extracurricular activities', null=True)),
                ('leadership', models.TextField(blank=True, help_text='Leadership roles', null=True)),
                ('achievements', models.TextField(blank=True, help_text='Other achievements', null=True)),
                ('participation', models.TextField(blank=True, help_text='Participation record', null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.FileField(help_text='Gallery image (jpg/jpeg/png/gif only)', upload_to='gallery_photos/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png', 'gif'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_section', models.CharField(blank=True, help_text='Student section (cached from student table)', max_length=50)),
