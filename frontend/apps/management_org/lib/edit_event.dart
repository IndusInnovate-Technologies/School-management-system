...
class _EditEventPageState extends State<EditEventPage> {
  ...
  String _selectedStatus = 'Upcoming'; // Required: Kept from gudisa
  // Note: _timeController and _selectedDate are removed in favor of _startDatetime
  ...
  EventPreviewData get _previewData => EventPreviewData(
        ...
        status: _selectedStatus, // Use the status variable from gudisa 
